...
define('word_form_factory',['tag_api'],function(tag_api) {
    'use strict';
...
define('word_manager',["ajax_api", 'tag_api', 'word_form_factory','editor_api','audio'],function(ajax_api, tag_api, WordFormFactory, Editor_API,AudioRecorder) {
    'use strict';
    const TOTAL_FORMS   = "TOTAL_FORMS";
    const INITIAL_FORMS = "INITIAL_FORMS";
    const MIN_NUM_FORMS = "MIN_NUM_FORMS";
