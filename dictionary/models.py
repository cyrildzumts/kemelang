...
class Langage(models.Model):
    ...
    editing = models.BooleanField(default=False, blank=True, null=True)
    start_editing_at = models.DateTimeField(blank=True, null=True)
    editing_token = models.CharField(blank=True, null=True)
