...
LABEL_GROUP = _('Group')
LABEL_GROUPS_PLURAL = _('Groups')
LABEL_GROUP_UPDATE = _('Group Update')
LABEL_GROUP_CREATE = _('New Group')

LABEL_TOKEN = _('Token')
LABEL_TOKEN_PLURAL = _('Tokens')
LABEL_PARTNER_TOKENS = _('Partner Tokens')
LABEL_TOKEN_CREATE = _('New Token')
LABEL_SELECT_ALL = _('Select all')
...
UI_FOOTER_LABEL = _('African Dictionary')
...
UI_PASSWORD_LABEL = _('Password')
UI_PASSWORD_REPEAT_LABEL = _('Repeat your Password')
UI_PASSWORD_FORGOT_LABEL = _('Forgot your password ?')
UI_USERNAME_LABEL = _('Username')
UI_FIRSTNAME_LABEL = _('First name')
UI_LASTNAME_LABEL = _('Last name')
UI_EMAIL_LABEL = _('E-Mail')
UI_SIGN_UP_INVITE_LABEL = _('New Here ? ')
UI_SIGN_IN_INVITE_LABEL = _('Already Have an Account ? ')
UI_ACCOUNT_LABEL = _('My Account')
UI_DELETE_ACCOUNT_LABEL = _('Delete Account')
UI_DELETE_ACCOUNT_WARNING_LABEL = _('Deleting your account is irreversible.')
UI_EDITOR_PLACEHOLDER = _("Start typing here ...")
UI_LINK_TO_SITE_LABEL = _('Visite the Site')
LABEL_MAINTENANCE_MODE = _('Maintenance Mode')
LABEL_ALLOW_ANONYMOUS_USERS = _('Allow Anonymous User')
UI_WELCOME_MAIL_TITLE = _("Welcome to %(site_name)s")
UI_NEW_USER_MAIL_TITLE = _("New user")
UI_MAIL_VALIDATION_TITLE = _("E-Mail validation")
...
UI_STRINGS_CONTEXT = {
    ...
    'UI_WELCOME_MAIL_TITLE': UI_WELCOME_MAIL_TITLE,
    'UI_NEW_USER_MAIL_TITLE': UI_NEW_USER_MAIL_TITLE,
    'UI_MAIL_VALIDATION_TITLE': UI_MAIL_VALIDATION_TITLE,
    'UI_FIRSTNAME_LABEL': UI_FIRSTNAME_LABEL,
    'UI_LASTNAME_LABEL': UI_LASTNAME_LABEL,
    'UI_EMAIL_LABEL': UI_EMAIL_LABEL,
    'UI_SEARCH_LABEL': UI_SEARCH_LABEL,
    'LABEL_GROUP': LABEL_GROUP,
    'LABEL_SELECT_ALL': LABEL_SELECT_ALL,
    'LABEL_GROUPS_PLURAL': LABEL_GROUPS_PLURAL,
    'LABEL_GROUP_UPDATE': LABEL_GROUP_UPDATE,
    'LABEL_GROUP_CREATE': LABEL_GROUP_CREATE,
    'UI_PASSWORD_LABEL': UI_PASSWORD_LABEL,
    'UI_PASSWORD_REPEAT_LABEL': UI_PASSWORD_REPEAT_LABEL,
    'UI_PASSWORD_FORGOT_LABEL': UI_PASSWORD_FORGOT_LABEL,
    'UI_USERNAME_LABEL': UI_USERNAME_LABEL,
    'UI_SIGN_UP_INVITE_LABEL': UI_SIGN_UP_INVITE_LABEL,
    'UI_SIGN_IN_INVITE_LABEL': UI_SIGN_IN_INVITE_LABEL,
    'UI_DELETE_ACCOUNT_LABEL': UI_DELETE_ACCOUNT_LABEL,
    'UI_DELETE_ACCOUNT_WARNING_LABEL': UI_DELETE_ACCOUNT_WARNING_LABEL,
    ...
    'DASHBOARD_DASHBOARD_TITLE': LABEL_DASHBOARD,
    'LABEL_DASHBOARD': LABEL_DASHBOARD,
    'DASHBOARD_TRANSLATOR_TITLE': LABEL_TRANSLATOR,
    ...
    'UI_LINK_TO_SITE_LABEL': UI_LINK_TO_SITE_LABEL,
